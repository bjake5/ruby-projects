...
def stock_picker(stock_prices)
  ...
  best_buy_sell_days_by_price = valid_buy_sell_days.max_by { |_a, _b, c| c }.flatten

  # Extract the buy and sell days from the pricing data
  [best_buy_sell_days_by_price[1], best_buy_sell_days_by_price[3]]
end
